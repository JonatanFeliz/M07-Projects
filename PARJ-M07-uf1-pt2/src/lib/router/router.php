...
function process_request(Request $request, Context $context, Table $route_table): array {
    ...
    if ($context->role == "client"){
        require_once(get_controller_dir() . '/controller-client.php');
    }
    else if($context->role == "journalist") {
        require_once(get_controller_dir() . '/controller-journalist.php');
    }
    else if($context->role == "admin") {
        require_once(get_controller_dir() . '/controller-admin.php');
    }
    else{
        require_once(get_controller_dir() . '/controller-guest.php');
    }
